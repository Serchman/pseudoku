...
export const PROGRESSION: ProgressionEntry[] = [
  ...
  { gate: 'board6x3:medium', n: 20, anchor: 'default:hard',    withSpeed: true,  requires: ['board6x3:easy'] },
  { gate: 'board6x3:hard',   n: 30, anchor: 'board6x3:medium', withSpeed: true,  requires: ['board6x3:medium'] },
];
